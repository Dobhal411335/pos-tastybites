...
import { Trash2, ListOrdered, CalendarClock } from "lucide-react";
...
export default function EmployeeCancelOrdersPage() {
  const [orders, setOrders] = useState([
    { id: 1, orderNumber: "ORD-085", guestName: "Emily Davis", amount: 32.50, status: "cancelled", time: "11:15 AM", reason: "Customer requested" },
    { id: 2, orderNumber: "ORD-086", tableNo: "Table 5", amount: 45.00, status: "cancelled", time: "11:45 AM", reason: "Out of stock item" },
  ]);
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 border-b border-zinc-200 pb-5">
            <div>
              ...
              <p className="text-[15px] mt-1" style={{ color: PALETTE.inkMuted }}>
                View all orders that have been cancelled.
              </p>
            </div>
          </div>
          ...
          <Card className="shadow-sm border-zinc-200 bg-white overflow-hidden">
            <CardHeader className="bg-zinc-50/50 border-b border-zinc-100 pb-4 flex flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-[18px] font-bold text-zinc-900">Cancelled Order History</CardTitle>
              </div>
              ...
              <Table>
                <TableHeader className="bg-zinc-50">
                  <TableRow>
                    ...
                    <TableHead className="text-[12px] font-bold uppercase tracking-wider text-zinc-500 py-4 px-6 text-center">Reason</TableHead>
                  ...
                  {orders.length === 0 ? (
                    ...
                    orders.map((o) => (
                      <TableRow key={o.id} className="h-16 hover:bg-zinc-50 transition-colors">
                        ...
                        <TableCell className="px-6 text-center">
                          <Badge className="bg-red-50 text-red-700 border-none px-3 py-1.5 text-[13px] font-semibold max-w-[120px] truncate" title={o.reason}>
                            {o.reason}
                          </Badge>
                        </TableCell>
                        <TableCell className="px-6 text-center">
