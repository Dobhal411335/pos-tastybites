...
import { Trash2, Edit, List, LogIn, ShoppingCart, Tag, UtensilsCrossed, Receipt, Plus } from "lucide-react";
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 border-b border-zinc-200 pb-5">
            <div>
              ...
              <p className="text-[15px] mt-1" style={{ color: PALETTE.inkMuted }}>
                Create and manage new food orders.
              </p>
            </div>
          </div>
                ...
                <Card className="shadow-sm border-zinc-200 bg-zinc-100 text-white overflow-hidden flex flex-col">
                  ...
                  <CardContent className="p-6 flex-1 flex flex-col justify-between space-y-6">
                    ...
                    <div>
                      ...
                      <Button className="w-full h-14 text-[16px] font-bold bg-[#F97316] hover:bg-[#e06510] text-white rounded-md shadow-lg transition-transform hover:scale-[1.02]">
                        Place Order
                      </Button>
                    </div>
                  </CardContent>
